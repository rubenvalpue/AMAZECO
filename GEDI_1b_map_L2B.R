...
gedi_dir = "C:/Lidar_EBA/RProcessing_Tutorial/GEDI_Data/L2B"

# A vector of metrics available from Level2B, as in the getLevel2BVPM documentation
metrics = c("rh100", "pai", "fhd_norm", "cover", "pgap_theta", "pai_z0_5m", "pavd_z0_5m")
...
out_root = "1_output/GEDI_maps_1km/"
